...
df=pd.read_csv(r'c:\Users\Ajitha\Desktop\Projects\final_data.csv')
...
with tab1:
    ...
    with col2:
        col2.image(Image.open(r"c:\Users\Ajitha\Desktop\Projects\reatail.jpg"), width=600)   
...
with tab2:
    ...
    if option == 'Prediction Process':
        ...
        with col10:
            ...
            import pickle
            model=pickle.load(open(r'c:\Users\Ajitha\Desktop\Projects\model.pkl', 'rb'))
            ...
            if st.button('Predict'):
                ...
                #st.success('Predicted weekly sales is {}'.format(result))
...
#CONCLUSION PAGE
    with tab3:
        ...
        with col9:
            st.image(Image.open(r"c:\Users\Ajitha\Desktop\Projects\retail2.png"), width=500)    
